...
| REQ-CUS-023 | Wishlist state cannot publish Product, override Product visibility, establish Price, reserve Stock, create a Stock Reservation, prove Available-to-Sell, authorize purchase, or alter Product, Pricing, Inventory, Cart, Checkout, or Order truth; removal or unavailability of a referenced Product produces a governed non-authoritative Wishlist outcome. |
...
| REQ-CUS-026 | Valid Customer creation establishes stable identity, supported Customer-owned data, correct ownership, and no accidental privilege; invalid, unauthorized, materially duplicate, or ambiguous creation is rejected safely and explainably or proceeds only through explicitly governed recovery where permitted. |
...
| REQ-CUS-037 | Staff User access is least-privilege, server-side authorized, purpose-bound, auditable where material, and protected against cross-Customer leakage; Administration cannot redefine Customer rules or bypass Customer ownership isolation. |
...
| REQ-CUS-041 | Applicable POPIA, consumer, privacy, commercial, contractual, and other legal obligations affecting Customer-data collection, use, access, correction, export, retention, deletion, disclosure, and cross-border handling remain subject to Approved purposes, accountable owners, and qualified validation before production reliance; this Specification establishes no compliance certification, lawful-basis determination, legal conclusion, or retention policy. |
| REQ-CUS-042 | Registration, Authentication, Account recovery, Customer-data access, and other applicable Customer workflows receive governed handling for suspicious or abusive behavior without bypassing Customer ownership, Authorization, auditability, privacy, or authoritative commercial state; false-positive recovery remains possible where governing policy permits it. |
...
| REQ-CUS-048 | Applicable duplicate registration, ambiguous identity, invalid Customer data, invalid Address, stale update, concurrent update, unauthorized access, cross-Customer access, recovery failure, Session expiry, access expiry, Customer data request failure, and unavailable Product, Order, Payment, or Shipping reference outcomes are distinguishable, safe, explainable, and recoverable where permitted; output exposes no Sensitive Data, Secrets, credentials, protected Account existence, inaccessible Resource existence, provider details, security controls, or implementation internals. |
| REQ-CUS-049 | Evidence covers applicable positive behavior, negative behavior, Customer isolation, Authorization, registration, duplicate identity, ambiguous identity, profile, Address, Preference, Consent, conditional Wishlist, concurrency, Sensitive Data, Administration access, Session-boundary behavior, recovery, accessibility, audit, Product, Pricing, Inventory, Cart, Checkout, Order, Payment, and Shipping boundary behavior, failure, and recovery without selecting a test framework, test-case identifier scheme, or numerical coverage target. |
